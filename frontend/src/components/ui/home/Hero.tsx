...
function Hero() {
  return (
    <section className="relative overflow-hidden rounded-3xl border border-slate-200 bg-linear-to-br from-white via-blue-50/60 to-sky-100/70 p-6 shadow-sm sm:p-8 lg:p-10">
